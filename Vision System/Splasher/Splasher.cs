...
namespace Vision_System
{
    public class Splasher
    {
        ...
        private static int m_TempProgress = 0;
        ...
        public static int Progress
        {
            set
            {
                if (m_SplashInterface == null || m_SplashForm == null)
                {
                    m_TempProgress = value;
                    return;
                }
                m_SplashForm.Invoke(
                        new SplashProgressChangedHandle(delegate (int intPrg) { m_SplashInterface.SetProgressInfo(intPrg); }),
                        new object[] { value }
                    );
            }
        }
        ...
        private delegate void SplashProgressChangedHandle(int NewProgressInfo);
